...
// //           {/* Right Content - Globe Component */}
// //           {/* UPDATED: This container now controls the size and centering */}
// //           <div className="relative flex items-center justify-center w-[300px] h-[300px] sm:w-[450px] sm:h-[450px] lg:w-[500px] lg:h-[500px] mx-auto lg:mx-0">
// //             <GlobeComponent />
// //           </div>
// //         </div>
// //       </div>
...
//             <div className="space-y-4">
//               <h1 className="text-4xl lg:text-6xl font-bold leading-tight tracking-tight">
//                 Fortify Cloud Solutions delivers <span className="text-blue-300">ERP applications</span> that simplify operations
//               </h1>
              
//               {/* <span className="text-blue-300 block"> ERP applications</span>  */}
//               <p className="text-xl lg:text-2xl text-blue-100/90 leading-relaxed max-w-xl mx-auto lg:mx-0">
//                 Fortify Cloud Solutions — Simplifying ERP, amplifying success
//               </p>
//             </div>

//             {/* CTA + Stats → hidden only on laptop (lg) */}
...
//           {/* Right Content - Globe Component */}
//           <div className="relative flex items-center justify-center w-[300px] h-[300px] sm:w-[450px] sm:h-[450px] lg:w-[500px] lg:h-[500px] mx-auto lg:ml-20">
//             <GlobeComponent />
//           </div>
//         </div>
//       </div>
