...
// // //   return (
// // //     // <div className="relative flex items-center justify-center mt-12 lg:mt-0 h-96 lg:h-[500px] w-1/2 md:w-1/3 lg:w-1/4 rounded-lg bg-yellow-500">
...
// // //     <div className="relative flex items-center justify-center mt-12 lg:mt-0 w-[500px] h-[500px] rounded-lg bg-yellow-500">
// // //   <Globe
// // //     ref={globeRef}
// // //     globeImageUrl="//unpkg.com/three-globe/example/img/earth-night.jpg"
// // //     arcsData={arcsData}
...
// //   // Return the Globe component directly, without a wrapper div
// //   return (
// //     <Globe
// //       ref={globeRef}
// //       globeImageUrl="//unpkg.com/three-globe/example/img/earth-night.jpg"
...
function GlobeComponent() {
  ...
  const calculateSize = () => {
    ...
    const scale = (screenWidth - 320) / (maxScreen - 320);
    const size = Math.floor(minSize + scale * (maxSize - minSize));
